...
module.exports = class extends BaseGenerator {
    ...
    writing() {
        ...
        //Add deploy file
        this.template('deploy/_deploy', `${resourceDir}/deploy/deploy`);
        ...
        this.template('jenkis/_jenkinsfile_int.sh', `${resourceDir}/pipelines/jenkinsfile_int.sh`);
        this.template('jenkis/_jenkinsfile_stage.sh', `${resourceDir}/pipelines/jenkinsfile_stage.sh`);
        this.template('jenkis/_jenkinsfile_prod.sh', `${resourceDir}/pipelines/jenkinsfile_prod.sh`); 
